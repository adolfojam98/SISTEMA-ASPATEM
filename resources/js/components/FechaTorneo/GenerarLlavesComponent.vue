<template>
    <div>
        <mostrar-partidos
            :partidos="categoria.partidosLlaves"
            :jugadores="categoria.jugadoresAnotados"
        ></mostrar-partidos>
    ...
    methods: {
        ...
        generarPartidos() {
            ...
            this.categoria.listaGrupos.forEach(grupo => {
                cantidadJugadores =
                    cantidadJugadores + grupo.jugadoresDelGrupo.length;
            });
            ...
            if (cantidadJugadores > 2 && cantidadJugadores < 4) {
                cantidadJugadoresExtras = 1;
                cantidadJugadores = cantidadJugadores - cantidadJugadoresExtras;
            } else if (cantidadJugadores > 4 && cantidadJugadores < 8) {
                cantidadJugadoresExtras = cantidadJugadores - 4;
                cantidadJugadores = cantidadJugadores - cantidadJugadoresExtras;
            } else if (cantidadJugadores > 8 && cantidadJugadores < 16) {
                cantidadJugadoresExtras = cantidadJugadores - 8;
                cantidadJugadores = cantidadJugadores - cantidadJugadoresExtras;
            } else if (cantidadJugadores > 16 && cantidadJugadores < 32) {
                cantidadJugadoresExtras = cantidadJugadores - 16;
                cantidadJugadores = cantidadJugadores - cantidadJugadoresExtras;
            } else if (cantidadJugadores > 32 && cantidadJugadores < 64) {
                cantidadJugadoresExtras = cantidadJugadores - 32;
                cantidadJugadores = cantidadJugadores - cantidadJugadoresExtras;
            } else if (cantidadJugadores > 64 && cantidadJugadores < 126) {
                cantidadJugadoresExtras = cantidadJugadores - 64;
                cantidadJugadores = cantidadJugadores - cantidadJugadoresExtras;
            }
            ...
            if (
                ...
                (cantidadJugadores == 64)
            ) {
                this.llavesPerfectas(
                    cantidadJugadores,
        ...
        generarPartidosDeAjuste(cantidadJugadoresExtras) {
            if (
                cantidadJugadoresExtras > 0 &&
                this.categoria.gruposConEliminatoria == false
            ) {
